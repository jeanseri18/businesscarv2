...
<head>
    ...
    <title>@yield('title', 'Administration') - Africa Business Card</title>
        ...
        <div class="w-64 gradient-bg text-white flex flex-col">
            ...
            <div class="p-6 border-b border-white border-opacity-20">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-lg font-bold">Admin ABC</h1>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('admin.dashboard') }}" 
                           class="sidebar-item flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.users.index') }}" 
                           class="sidebar-item flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.users*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.enterprises.index') }}" 
                           class="sidebar-item flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.enterprises*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.commerciaux.index') }}" 
                           class="sidebar-item flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.commerciaux*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.subscriptions.index') }}" 
                           class="sidebar-item flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.subscriptions*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.payments.index') }}" 
                           class="sidebar-item flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.payments*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.purchases.index') }}" 
                           class="sidebar-item flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.purchases*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.offres.index') }}" 
                           class="sidebar-item flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.offres*') ? 'active' : '' }}">
            ...
            <div class="p-4 border-t border-white border-opacity-20">
                ...
                <div class="space-y-1 mb-3">
                    <a href="{{ route('admin.profile.edit') }}" 
                       class="sidebar-item flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.profile.edit') ? 'active' : '' }}">
                        <i class="fas fa-user-edit mr-3 w-5 text-center"></i>
                        <span>Modifier profil</span>
                    </a>
                    <a href="{{ route('admin.profile.password') }}" 
                       class="sidebar-item flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.profile.password') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.logout') }}" 
                   class="sidebar-item flex items-center px-4 py-2 rounded-lg w-full">
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600">@yield('page_subtitle', 'Gestion de la plateforme')</p>
                        </div>
